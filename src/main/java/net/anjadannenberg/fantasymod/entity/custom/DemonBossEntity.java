package net.anjadannenberg.fantasymod.entity.custom;
...
public class DemonBossEntity extends Monster implements RangedAttackMob {

    private static final EntityDataAccessor<Integer> DATA_TARGET_A = SynchedEntityData.defineId(DemonBossEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_TARGET_B = SynchedEntityData.defineId(DemonBossEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_TARGET_C = SynchedEntityData.defineId(DemonBossEntity.class, EntityDataSerializers.INT);
    private static final List<EntityDataAccessor<Integer>> DATA_TARGETS = ImmutableList.of(DATA_TARGET_A, DATA_TARGET_B, DATA_TARGET_C);
    private static final EntityDataAccessor<Integer> DATA_ID_INV = SynchedEntityData.defineId(DemonBossEntity.class, EntityDataSerializers.INT);
    ...
    public DemonBossEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
     ...
     */
    public static BlockState canEntityDestroy(net.minecraft.world.level.BlockGetter blockGetter, BlockPos blockPos, Entity entity) {

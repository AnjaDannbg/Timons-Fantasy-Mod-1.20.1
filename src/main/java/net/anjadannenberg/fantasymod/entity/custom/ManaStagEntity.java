...
public class ManaStagEntity extends Animal {
    public ManaStagEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.MANA_STAG.get().create(pLevel);
    }
